...
const QuestionnaireMP: React.FC = () => {
    ...
    return (
        <div className={styles.container}>
            ...
            <button className={styles.button} onClick={() => answer(BestPracticeAnswerType.APPLICABLE)}>Bannissable</button> <br />
            <button className={styles.button} onClick={() => answer(BestPracticeAnswerType.ALREADY_APPLICABLE)}>Déjà bannie</button> <br />
            <button className={styles.button} onClick={() => answer(BestPracticeAnswerType.NOT_APPLICABLE)}>Compliquée à éviter</button> <br />
